...
def get_models(file_path, channels, params, use_flows, spin_distr=None, sensitivity=None, normalize=False, detectable=False, device='cpu', use_unityweights=False, **kwargs):
    """
