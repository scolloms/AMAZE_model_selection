#! /bin/bash
#runs model select with cpu, with flows, and preset file paths
#training flow models with randomly chosen weighted samples instead of weighted KL, then inference with all events
