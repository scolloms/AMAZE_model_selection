...
for channel_label in channels:
    ...
    if channel_label == 'CE':
        ...
        np.save(f'{channel_label}_flow_KDE_KL.npy', flow_KDE_KL)
        np.save(f'{channel_label}_KDE_flow_KL.npy', KDE_flow_KL)
        ...
        #save flow_KL-kde_KL
        np.save(f'{channel_label}_flow_KL_minus_KDE_KL.npy', flow_KL-KDE_KL)
    else:
